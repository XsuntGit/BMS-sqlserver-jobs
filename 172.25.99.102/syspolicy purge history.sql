/*
	Created by XSUNT\svc-jenkins using dbatools Export-DbaScript for objects on 172.25.99.102 at 08/06/2023 21:25:26
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'syspolicy_purge_history_schedule', 
		...
		@schedule_uid=N'790be624-1c9c-471d-8333-bac5b602ee16'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
