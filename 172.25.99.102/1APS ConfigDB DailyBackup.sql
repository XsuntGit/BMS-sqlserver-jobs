/*
	Created by XSUNT\svc-jenkins using dbatools Export-DbaScript for objects on 172.25.99.102 at 08/06/2023 21:25:04
...
EXEC  [dbo].[sp_ConfigDB_weeklyPA102toDR]
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'run daily config bkp', 
		@enabled=1, 
		@freq_type=4, 
		@freq_interval=1, 
		@freq_subday_type=1, 
		...
		@schedule_uid=N'c7c53585-4d89-49ed-8892-b3d714613049'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
