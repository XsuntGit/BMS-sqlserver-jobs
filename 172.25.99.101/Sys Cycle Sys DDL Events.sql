/*
	Created by XSUNT\svc-jenkins using dbatools Export-DbaScript for objects on 172.25.99.101 at 08/06/2023 21:22:37
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Cycle_Sys_DDL_Events', 
		...
		@schedule_uid=N'e1420084-33d2-498a-a4d9-1f720db4e141'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
